...
$(DEBUGDIR)main.o : $(SRCDIR)Container.h $(SRCDIR)ListContainer.h $(SRCDIR)VecContainer.h $(SRCDIR)DblVector.h $(SRCDIR)main.cpp
...
$(RELEASEDIR)main.o : $(SRCDIR)Container.h $(SRCDIR)ListContainer.h $(SRCDIR)VecContainer.h $(SRCDIR)DblVector.h $(SRCDIR)main.cpp
